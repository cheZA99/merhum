...
{
    Task<PagedResponse<AppointmentResponse>> GetAllAsync(int? deceasedId, string? status, int? mosqueId, int? imamId, DateTime? dateFrom, DateTime? dateTo, int pageNumber, int pageSize);
